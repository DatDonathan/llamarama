...
public abstract class AbstractBullet extends CollisionDamager {
	...
	public void hostUpdate(Level level, UpdateEvent event) {
		...
		if ((component != null && component.nearBounds(this)) || !level.getTileSystem().getTilesInAbsoluteArea(getX() - 0.001, getY() - 0.001, getZ() - 0.001, getWidth() + 0.002, getHeight() + 0.002, getLength() + 0.002, getArea()).isEmpty() || level.getObjectsInArea(getX() - 0.001, getY() - 0.001, getZ() - 0.001, getWidth() + 0.002, getHeight() + 0.002, getLength() + 0.002, getArea()).stream().anyMatch(o -> {
